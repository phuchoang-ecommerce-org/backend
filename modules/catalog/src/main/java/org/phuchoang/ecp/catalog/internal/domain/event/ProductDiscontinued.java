...
@DomainEvent
public record ProductDiscontinued(UUID productId, List<String> variantSkus) implements CatalogDomainEvent {
    public ProductDiscontinued { variantSkus = List.copyOf(variantSkus); }
