...
class CatalogDomainEventTest {
    ...
    void productFactsExposeTheCanonicalEventAndAggregateIdentity() {
        ...
        Product product = new Product(productId, UUID.randomUUID(), "Shirt", "shirt", null, null, "DRAFT", null,
        ...
        CatalogDomainEvent variantAdded = new VariantAdded(productId, product.variants().getFirst());
