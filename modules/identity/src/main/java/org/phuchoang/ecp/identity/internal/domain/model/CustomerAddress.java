 ...
 * An entity owned by the {@link Account} aggregate. Address reads may use an Identity-owned query
 * gateway, but writes remain part of Account's consistency boundary.
 *
