...
/** JPA mapping of {@code identity_account} (Database.md §4.1) — the persistence shape only; {@link org.phuchoang.ecp.identity.internal.domain.model.Account} is the behaviour. */
@Entity
