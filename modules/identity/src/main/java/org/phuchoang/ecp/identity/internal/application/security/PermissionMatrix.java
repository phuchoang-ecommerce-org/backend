...
import static org.phuchoang.ecp.identity.internal.domain.model.RoleCode.ADMINISTRATOR;
import static org.phuchoang.ecp.identity.internal.domain.model.RoleCode.CUSTOMER;
import static org.phuchoang.ecp.identity.internal.domain.model.RoleCode.CUSTOMER_SUPPORT;
import static org.phuchoang.ecp.identity.internal.domain.model.RoleCode.GUEST;
import static org.phuchoang.ecp.identity.internal.domain.model.RoleCode.STAFF;
import static org.phuchoang.ecp.identity.internal.domain.model.RoleCode.WAREHOUSE_OPERATOR;
...
public final class PermissionMatrix {
     ...
     * {@code identity.api.IdentityAuthorization} consults; revisit when a per-module matrix
     * exists.
     */
