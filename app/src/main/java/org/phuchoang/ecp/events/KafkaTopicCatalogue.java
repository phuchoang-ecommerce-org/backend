...
class KafkaTopicCatalogue {
    ...
    List<TopicDefinition> sources() {
        return List.of(
            ...
            source("ecp.catalog.product.v1", 6, "ecp.catalog", "ecp.web-revalidation", "ecp.audit", "ecp.reporting"),
            source("ecp.catalog.category.v1", 3, "ecp.catalog", "ecp.web-revalidation", "ecp.audit", "ecp.reporting"),
